...
public class ChangeAccountOwnedPasswordEvent(string ownedAccountId, string ownedAccountSubjectId, string email) : IIntegrationEvent, IRequest<bool>
{
    [JsonInclude]
...
public class ChangeAccountOwnedPasswordEventHandler(IAuth0ManagementClient managementClient) : IRequestHandler<ChangeAccountOwnedPasswordEvent, bool>
{
    public async Task<bool> Handle(ChangeAccountOwnedPasswordEvent command, CancellationToken cancellationToken)
    {
        await managementClient.InitiateChangePasswordFlow(
            email: command.Email,
...
public class ChangeAccountOwnedPasswordEventValidator : AbstractValidator<ChangeAccountOwnedPasswordEvent>, IValidator<ChangeAccountOwnedPasswordEvent>
{
    public ChangeAccountOwnedPasswordEventValidator()
    {
